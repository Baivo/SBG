...
adv_healthbar:
    ...
    events:
        ...
        - if <context.entity.health.sub[<context.final_damage>]> > 0:
            ...
            - define armorDisplay <&b><&o>🛡<&8>-<&7><&l><context.entity.armor_bonus>
            - define healthDisplay <&c><&o>❤<&8>-<&color[<[color]>]><element[|].repeat[<[remainingHealth]>]><&8><element[|].repeat[<[damageDone]>]>
